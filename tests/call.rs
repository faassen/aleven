// use aleven::run::{
//     compiled, interpreted, run_interpreter_program, run_llvm_program, Run, RunnerProgram,
// };
// use aleven::{parse, Program};
...
//     let program = Program::new(&[(0, &main_instructions), (0, &sub_instructions)]);
